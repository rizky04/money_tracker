<!-- Bottom Navigation -->
<div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-6 py-3 z-50 flex justify-around items-center shadow-[0_-4px_10px_rgba(0,0,0,0.05)]">
...
<!-- Floating Action Button untuk Kamera (terpisah) -->
<div class="fixed bottom-24 right-6 z-50" x-data="{}">
    <button
        type="button"
        @click="$dispatch('buka-kamera')"
        class="bg-gas-green text-white p-4 rounded-full shadow-lg active:scale-95 transition-transform">
