<div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 py-2 z-50 shadow-[0_-4px_10px_rgba(0,0,0,0.05)]">
    <div class="grid grid-cols-6 gap-1 px-2">
        ...
        <a href="{{ route('dashboard') }}" class="flex flex-col items-center gap-1 py-2 rounded-xl transition-all {{ request()->routeIs('dashboard') ? 'text-gas-green bg-green-50' : 'text-gray-400 hover:bg-gray-50' }}">
        ...
        <a href="{{ route('history') }}" class="flex flex-col items-center gap-1 py-2 rounded-xl transition-all {{ request()->routeIs('history') ? 'text-gas-green bg-green-50' : 'text-gray-400 hover:bg-gray-50' }}">
        ...
        <a href="{{ route('account') }}" class="flex flex-col items-center gap-1 py-2 rounded-xl transition-all {{ request()->routeIs('account') ? 'text-gas-green bg-green-50' : 'text-gray-400 hover:bg-gray-50' }}">
